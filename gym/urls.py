...
urlpatterns = [
    ...
    path('member/<int:member_id>/', views.member_detail_view, name='view_member'),
    path('member/<int:member_id>/edit/', views.edit_member_view, name='edit_member'),
    ...
    path('all-equipment/', views.all_equipment, name='all_equipments'),
